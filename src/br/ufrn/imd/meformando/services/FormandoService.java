...
public class FormandoService {
	...
	/*
	 * ! Valida dados de formando enviados por parametro de acordo com as regras de
	 * negocio, para depois solicitar ao repositorio que o adicione
	 * 
	...
	public Formando adicionar(Formando formando) throws BusinessException {
		...
		if (formando.getNome().equals("") || formando.getCpf().equals("") || formando.getEmail().equals("")
				|| formando.getSenha().equals("") || formando.getNome() == null || formando.getCpf() == null
				|| formando.getEmail() == null || formando.getSenha() == null)
		...
		if (formandoDB != null)
			throw new BusinessException("Ja possuimos usuario com este CPF cadastrado");
	...
	/*
	 * ! Solicita ao repositorio um formando com determinado email salvo no banco de
	 * dados
	 * 
